...
Built upon the Zen Designer architecture, this model achieves state-of-the-art performance while maintaining exceptional efficiency 
...
Zen-Designer-Instruct is based on the Zen Designer architecture with several key modifications:
